...
// Synthesized placeholder WAVs ship with the repo (generated by
// scripts/generate_placeholder_sounds.py). To upgrade to nicer sounds:
//   1. Download CC0 audio from Mixkit (no login, free for any use):
//        click:     https://mixkit.co/free-sound-effects/click/
//        celebrate: https://mixkit.co/free-sound-effects/win/
//   2. Drop them in static/sounds/ and either keep the .wav filenames or
//      update both the file extension and the paths below to .mp3.
// If a file is missing the Audio call silently no-ops — the game still
// works, you just lose the sound effect.
const sounds = {
...
function toggleMark(r, c) {
  // FREE is always marked — clicking it does nothing (and gives no
  // click feedback, since the absence of feedback is itself a signal).
